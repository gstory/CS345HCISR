...
//for( int i = 0; i < sig.size(); i++ ) System.out.print(methodSignature[i] + " ");
//System.out.println();
...
//codeblock -> statement -> setcall returns statement ast - done?
 ...
 HCISRMethodCallAST methodcallreturn = null; HCISRFunctionCallAST functioncallreturn = null; HCISRConstructorCallAST constructorcallreturn = null; Token e; HCISRDefineCallAST definecallreturn = null; Token f; String s;
    ...
    case TO:
    case TRUE:
	f = jj_consume_token(TRUE);
	definecallreturn = new HCISRDefineCallAST(new String[]{"Boolean"}, e.image, f.image, 4);
	break;
    case FALSE:
	f = jj_consume_token(FALSE);
	definecallreturn = new HCISRDefineCallAST(new String[]{"Boolean"}, e.image, f.image, 4);
	break;
    case DO:
    case THEN:
    ...
    case STRINGREF:
	s = String();
	definecallreturn = new HCISRDefineCallAST(new String[]{"String"}, e.image, s, 0);
	break;
   //GS
    case INTREF:
	s = Int();
//System.out.println("asdf "+s);
    ...
    case FLOATREF:
	s = Float();
	definecallreturn = new HCISRDefineCallAST(new String[]{"Float"}, e.image, s, 2);
	break;
    case FUNCTIONREF:
	s = Functioninit();
	definecallreturn = new HCISRDefineCallAST(new String[]{"Function"}, e.image, s, 3);
	break;
    case BOOLREF:
	s = Bool();
	definecallreturn = new HCISRDefineCallAST(new String[]{"Boolean"}, e.image, s, 4);
	break;
    case and_in_the_event_of_a:
    case the_following_functions_make_use_of:
//GS
